...
export const students = pgTable("students", {
  ...
  resumeApproved: boolean("resume_approved").default(false),
  resumeApprovedBy: uuid("resume_approved_by").references(() => directors.id),
  resumeApprovedAt: timestamp("resume_approved_at"),
